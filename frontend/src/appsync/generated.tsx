...
export type GetEventQuery = { __typename?: "Query" } & {
  getEvent?: Maybe<
    ...
    > & {
        comments?: Maybe<
          { __typename?: "CommentConnection" } & Pick<
            CommentConnection,
            "nextToken"
          >
        >;
...
export type ListEventsQuery = { __typename?: "Query" } & {
  listEvents?: Maybe<
    { __typename?: "EventConnection" } & Pick<EventConnection, "nextToken"> & {
        items?: Maybe<
          Array<
            Maybe<
              { __typename?: "Event" } & Pick<
...
export type CommentOnEventMutation = { __typename?: "Mutation" } & {
  commentOnEvent?: Maybe<
    { __typename?: "Comment" } & Pick<
      Comment,
      "commentId" | "content" | "createdAt" | "eventId"
    >
  >;
};
...
export function useGetEventLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<GetEventQuery, GetEventQueryVariables>(
    GetEventDocument,
    baseOptions
  );
}
...
export function useListEventsQuery(
  ...
  return ApolloReactHooks.useQuery<ListEventsQuery, ListEventsQueryVariables>(
    ListEventsDocument,
    baseOptions
  );
}
export function useListEventsLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<
    ListEventsQuery,
    ListEventsQueryVariables
  >(ListEventsDocument, baseOptions);
}
...
>;
export type ListEventsQueryResult = ApolloReactCommon.QueryResult<
  ListEventsQuery,
  ListEventsQueryVariables
>;
...
`;
export type CommentOnEventMutationFn = ApolloReactCommon.MutationFunction<
  CommentOnEventMutation,
 ...
 * });
 */
export function useCommentOnEventMutation(
  ...
  return ApolloReactHooks.useMutation<
    CommentOnEventMutation,
    CommentOnEventMutationVariables
  >(CommentOnEventDocument, baseOptions);
}
export type CommentOnEventMutationHookResult = ReturnType<
  typeof useCommentOnEventMutation
>;
export type CommentOnEventMutationResult = ApolloReactCommon.MutationResult<CommentOnEventMutation>;
export type CommentOnEventMutationOptions = ApolloReactCommon.BaseMutationOptions<
  CommentOnEventMutation,
  CommentOnEventMutationVariables
>;
 ...
 * });
 */
export function useSubscribeToEventCommentsSubscription(
  baseOptions?: ApolloReactHooks.SubscriptionHookOptions<
    SubscribeToEventCommentsSubscription,
    SubscribeToEventCommentsSubscriptionVariables
  >
) {
  return ApolloReactHooks.useSubscription<
    SubscribeToEventCommentsSubscription,
    SubscribeToEventCommentsSubscriptionVariables
  >(SubscribeToEventCommentsDocument, baseOptions);
}
export type SubscribeToEventCommentsSubscriptionHookResult = ReturnType<
  typeof useSubscribeToEventCommentsSubscription
>;
